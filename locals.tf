locals {
  ...
  cluster_instances_ids   = var.cluster_network_shape == "BM.GPU.GB200.4" || var.cluster_network_shape == "BM.GPU.GB200-v2.4" ||var.cluster_network_shape == "BM.GPU.GB300.4" ? data.oci_core_instance.memory_cluster_network_instances.*.id : var.stand_alone ? var.rdma_enabled ? oci_core_instance.compute_cluster_instances.*.id : oci_core_instance.compute_instances.*.id : var.rdma_enabled ? data.oci_core_instance.cluster_network_instances.*.id : data.oci_core_instance.instance_pool_instances.*.id
  cluster_instances_names = var.cluster_network_shape == "BM.GPU.GB200.4" || var.cluster_network_shape == "BM.GPU.GB200-v2.4" ||var.cluster_network_shape == "BM.GPU.GB300.4" ? data.oci_core_instance.memory_cluster_network_instances.*.display_name : var.stand_alone ? var.rdma_enabled ? oci_core_instance.compute_cluster_instances.*.display_name : oci_core_instance.compute_instances.*.display_name : var.rdma_enabled ? data.oci_core_instance.cluster_network_instances.*.display_name : data.oci_core_instance.instance_pool_instances.*.display_name
