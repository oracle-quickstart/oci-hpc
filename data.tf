...
data "oci_core_cluster_network_instances" "cluster_network_instances" {
  count              = (!var.stand_alone) && var.rdma_enabled && var.node_count > 0 && var.cluster_network_shape != "BM.GPU.GB200.4" && var.cluster_network_shape != "BM.GPU.GB200-v2.4" && var.cluster_network_shape != "BM.GPU.GB300.4" ? 1 : 0
...
data "oci_core_compute_gpu_memory_cluster_instances" "memory_cluster_network_instances" {
  count                         = var.node_count > 0 && (var.cluster_network_shape == "BM.GPU.GB200.4" || var.cluster_network_shape == "BM.GPU.GB200-v2.4" || var.cluster_network_shape == "BM.GPU.GB300.4") ? 1 : 0
...
data "oci_core_instance" "cluster_network_instances" {
  count       = (!var.stand_alone) && var.rdma_enabled && var.node_count > 0 && var.cluster_network_shape != "BM.GPU.GB200.4" && var.cluster_network_shape != "BM.GPU.GB200-v2.4" && var.cluster_network_shape != "BM.GPU.GB300.4" ? var.node_count : 0
