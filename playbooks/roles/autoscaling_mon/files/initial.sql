CREATE TABLE IF NOT EXISTS cluster_log.clusters (
    ...
    resize_log VARCHAR(128),
    started_creation TIMESTAMP,
    started_resize TIMESTAMP,
    created TIMESTAMP,
    creation_time TIME,
    started_deletion TIMESTAMP,
    deleted TIMESTAMP,
    deletion_time TIME,
    state ENUM('creating', 'running', 'deleting', 'deleted','resizing'),
...
CREATE TABLE IF NOT EXISTS cluster_log.errors_timeserie (
    ...
    state ENUM('creation','deletion','oci','resize'),
