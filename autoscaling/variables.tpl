...
variable "cluster_network" { default = "${cluster_network}"} 
variable "use_custom_name" {default = true}
variable "cluster_name" {default = "##NAME##" }
variable "cluster_network_shape" { default = "${cluster_network_shape}" }
variable "instance_pool_shape" { default = "${instance_pool_shape}" }
