import click
from lib.cli.configurations.display import print_config_list_yaml,print_config_list
...
@click.command()
@click.option('--yaml', help='Name of the file for a yaml output.')
...
def list(yaml, partition, shape):
    ...
    if partition:
        ...
        if shape:
            ...
            title="All"
    if yaml:
        print_config_list_yaml(configurations,yaml)
    else:
