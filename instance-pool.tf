resource "oci_core_instance_pool" "instance_pool" {
  ...
  depends_on                = [oci_core_app_catalog_subscription.mp_image_subscription, oci_core_subnet.private-subnet, oci_core_subnet.public-subnet, oci_functions_function.function, null_resource.controller, null_resource.invoke_and_assert]
